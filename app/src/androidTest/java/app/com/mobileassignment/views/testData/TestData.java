...
public class TestData {
    ...
    public static String getCityCaniza() {
        return cityCaniza;
    }

    public static String getCityName1ForTest() {
        return cityName1ForTest;
    }

    public static String getCityName2ForTest() {
        return cityName2ForTest;
    }

    public static String getCityName3ForTest() {
        return cityName3ForTest;
    }
    ...
    public static String getCityAbbotsfordUpperCase() {
        return cityAbbotsfordUpperCase;
    }

    public static String getCityAbbotsfordLowerCase() {
        return cityAbbotsfordLowerCase;
    }

    public static String getCityAbbotsford() {
        return cityAbbotsford;
    }
}
